...
export default function Cards({ isDark }) {
    return (
        <div
            className={`rounded-2xl shadow-md w-full overflow-hidden border-2 ${
                isDark
        ...
        >
            ...
            <div className="p-5 space-y-3">
                <div className="flex justify-between items-center">
                    ...
                    <div
                        className={`flex items-center gap-1 text-sm p-1 rounded-md ${
                            isDark
                ...
                <button
                    className={`w-full mt-4 font-bold py-3 rounded-xl transition border ${
                        isDark
                            ? "bg-[#1E293B] hover:bg-[#1f2836] border-[#334155] text-[#CBD5F5]"
                            : "bg-[#F8FAFC] hover:bg-[#ecefef] text-[#334155] border-[#F1F5F9]"
                    }`}
                >
                    View Profile
                </button>
