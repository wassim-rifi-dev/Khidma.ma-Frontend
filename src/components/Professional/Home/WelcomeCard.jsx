...
export default function WelcomeCard({ user }) {
    const firstName = user?.first_name || "Professional";
    const photoUrl = getUserPhotoUrl(user?.photo) || defaultProfile;

    return (
        <div className="relative flex min-h-[280px] w-full items-center justify-between overflow-hidden rounded-[30px] border border-slate-100 bg-white px-14 py-14 shadow-[0_22px_55px_rgba(15,23,42,0.07)]">
            <div className="pointer-events-none absolute right-0 top-0 h-full w-[42%] bg-gradient-to-l from-orange-50 via-orange-50/55 to-transparent" />
