        ...
        <section className={`py-16 md:py-20 px-6 sm:px-8 lg:px-12 ${
            ...
            <div className="w-full mx-auto text-center">
                ...
                <div className="relative flex flex-col md:flex-row items-start justify-between gap-12 md:gap-6">
                    ...
                    <div className="relative z-10 flex flex-col items-center flex-1 text-center group">

                        <div className="w-16 h-16 md:w-20 md:h-20 bg-[#F97415] text-white rounded-full flex items-center justify-center text-2xl md:text-3xl font-bold mb-6 md:mb-8 transition-transform group-hover:scale-110 duration-300">
                            1
                        </div>
                        ...
                        <p className={`leading-relaxed max-w-xs md:max-w-70 ${
                            isDark ? 'text-[#94A3B8]' : 'text-[#64748B]'
                        }`}>
                    ...
                    <div className="relative z-10 flex flex-col items-center flex-1 text-center group">
                        ...
                        <div className={`w-16 h-16 md:w-20 md:h-20 text-[#F97415] border-3 border-[#F97415] rounded-full flex items-center justify-center text-2xl md:text-3xl font-bold mb-6 md:mb-8 transition-transform group-hover:scale-110 duration-300 ${
